...
## In Progress
- `feature/add-widget` — add widget functionality (NEW)
- `feature/update-share-option` — GIF sharing feature (merged to main)
...
| GIF generation | `src/lib/generateJokeGif.ts` |
...
GROK_API_KEY=    # optional, for AI-generated jokes
BUILD_ID=        # optional, set by Vercel
```

## Research & Planning
- See `docs/` folder for architecture research and planning documents:
  - `grok-joke-fetching-architecture.md` — Grok API integration plan
